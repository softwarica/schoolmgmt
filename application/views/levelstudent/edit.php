    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Level & Student Edit</h3>
            </div>
			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<option><?php echo ($this->input->post('level_name') ? $this->input->post('level_name') : $tbllevelstudent['level_name']); ?></option>
							<?php
					...
					<div class="col-md-6">
						...
						<option><?php echo ($this->input->post('student_name') ? $this->input->post('student_name') : $tbllevelstudent['student_name']); ?></option>
							<?php
